...
const QuizzesCard = (props) => {
  ...
  const [beginDate, setBeginDate] = useState(props.quizzesBeginTime);
  const [endDate, setEndDate] = useState(props.quizzesEndTime);
  ...
  const onDeleteQuiz = () => {
    dispatch(removeQuizzes(props._quizzesId));
  }

  const editCreatedQuizzes = () => {
    props.navigation.navigate('CreateQuizzes', {
      quizzesId: props._quizzesId,
      quizzesName: props.quizzesName,
      quizzesImage: props.quizzesImage,
      quizzesDescription: props.quizzesDescription,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.quizNameAndStatus}>{props.quizzesName}</Text>
      ...
      <View style={styles.row}>
        <TouchableOpacity onPress={editCreatedQuizzes}>
